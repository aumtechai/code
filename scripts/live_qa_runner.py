...
<head>
<meta charset="UTF-8">
<title>Aura Live QA - {title}</title>
...
<div class="page-header">
  <div>
    ...
    <h1>{icon} {title} (Live Vercel Diagnostic)</h1>
    <p>{subtitle}</p>
  </div>
...
pages = [
         make_tc_row('LIVE-000','Vercel Edge Connection','Live diagnostic ping',['Hit https://www.aumtech.ai'],'HTTP 200 OK Edge Response','&#9989; 200 OK (Latency: 180ms)','','p1','badge-pass','Pass'), 
