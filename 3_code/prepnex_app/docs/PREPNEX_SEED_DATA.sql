...
BEGIN
    FOR i IN 1..100 LOOP
        ...
        -- Insert Student
        INSERT INTO prepnex.students (full_name, current_grade, target_major, target_universities, alignment_score)
        ...
        INSERT INTO prepnex.academic_roadmaps (student_id, grade_level, course_type, course_name, status, grade)
        VALUES 
        ...
        INSERT INTO prepnex.profile_activities (student_id, activity_name, activity_type, his_score, status)
        VALUES 
        ...
        INSERT INTO prepnex.test_history (student_id, test_type, score, is_actual)
        VALUES (v_student_id, 'PSAT', floor(random() * (1520 - 1000 + 1) + 1000), TRUE);

        -- Initialize Vesta Context
        INSERT INTO prepnex.ai_context (student_id, conversation_summary, last_strategy_nudge)
